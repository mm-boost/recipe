...
$(function () {
  $(document).on('click', '#food_cre', function () {
    ...
    cell3.innerHTML = '<td class="foodunit"><select name="unit[]" class="unit"><option value="">単位</option><option value="1">cc</option><option value="2">ml</option><option value="3">g</option><option value="4">本</option><option value="5">個</option><option value="6">枚</option><option value="7">束</option><option value="8">缶</option><option value="9">袋</option><option value="10">房</option><option value="11">切</option><option value="12">合</option><option value="13">適量</option>';
...
__webpack_require__(/*! /home/ubuntu/dev/recipe/resources/js/app.js */"./resources/js/app.js");
__webpack_require__(/*! /home/ubuntu/dev/recipe/resources/sass/app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! /home/ubuntu/dev/recipe/resources/sass/admin.scss */"./resources/sass/admin.scss");
